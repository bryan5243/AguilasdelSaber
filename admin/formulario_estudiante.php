...
<head>
    ...
    <title>Formulario Estudiante, Papá y Mamá</title>
    <style>
        body {
...
<div class="container">
    <form id="formularioFamilia" action="procesar_estudiante.php" method="post" enctype="multipart/form-data">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="cedula_estudiante" name="cedula_estudiante" pattern="[0-9]*" required>
        </div>
        <div class="form-group">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="cedula_papa" name="cedula_papa" pattern="[0-9]*" required>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="telefono_papa" name="telefono_papa" pattern="[0-9]*" required>
        </div>
        <div class="form-group">
...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="cedula_mama" name="cedula_mama" pattern="[0-9]*" required>
        </div>
        <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="telefono_mama" name="telefono_mama" pattern="[0-9]*" required>
        </div>
        <div class="form-group">
