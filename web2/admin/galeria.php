...
<div class="container">
    ...
    language: {
        ...
        //Aqui va el codigo de insert
            ...
            $(document).on('click', '.editar', function(){
                ...
                $.ajax({
                    ...
                    success: function(data){
                        ...
                        $('#modal-title').text("Editar Galeria");
                        $('#action').text("Editar");
            ...
            var id_galeria= $(this).attr("id");
            if(confirm ("Estas seguro que quieres borrar este registro: "+ id_galeria)){
